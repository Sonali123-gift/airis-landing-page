...
Screenshot 2026-07-23 at 11.25.26 AM.png
professor told me to make this into moving particles for lens and earbuds and other things and if we click one circle which moving around it spotlit and blur other htings 

That's actually a much stronger idea than a static hero section. Your professor is suggesting turning it into an interactive product showcase instead of a normal landing page. It will feel much more like Apple Vision Pro, Nothing, or Tesla websites.
...
Make it like this:
      ...
      Glasses ●        ● Contact Lens
        ...
        Phone ●              Ring ●
               ...
               Smart Case ●
All devices slowly orbit around the Airis logo.

Animation
Every product moves continuously.
...
Blur
Opacity 25%
Background also becomes darker.

Then a panel appears.
...
━━━━━━━━━━━━━━━━━━━━━━
When clicking Earbuds

Lens fades.

Earbuds move to center.
...
opacity:.25;
Background
Instead of empty dots,

make particles.

Like tiny glowing dots.
...
Some connect with thin glowing lines.
...
Apple WWDC animations

Lens animation
The contact lens itself should slowly rotate.
...
Orbit animation
Each product has a different orbit.
...
Suggested technologies (easy in Next.js)
Framer Motion – smooth movement, scaling, and transitions.

React Three Fiber (optional) – if you want a 3D orbit effect.

tsParticles – animated particle background.

GSAP – advanced timeline animations if you need more control.
...
Particles animate
        │
        ▼
Products orbit around Airis
        │
        ▼
User hovers a product
        │
        ▼
Product glows
        │
...
User clicks
        │
        ▼
Selected product moves forward
        │
        ▼
Other products blur and fade
        │
        ▼
Information card slides in
        │
        ▼
Close or select another product
        │
        ▼
Orbit resumes
I think this would impress your professor because it demonstrates:
A hero section that tells a story instead of just showing a product.

Interactive exploration, where users discover features by clicking.

Modern motion design with purposeful animations rather than decorative effects.

A premium, futuristic feel that fits an AI hardware startup.

If you're building this in Next.js + Tailwind + Framer Motion, I can also provide the complete component structure and animation logic so you can implement this step by step.



Pasted text(25).txt
Document
tell me what to add code here 

Yes. Looking at your code, the part your professor wants you to change is the Hero section (the right side with the Airis logo and the three glass cards). 


Instead of adding more static cards, I'd replace it with an interactive product orbit.
...
const [selectedProduct, setSelectedProduct] = useState("lens");
3. Create products array
Above return(
...
4. Replace the entire RIGHT SIDE
Replace this
    ...
    {products.map((item,index)=>(
        ...
        <motion.button
            ...
            ${
                ...
                ?"bg-cyan-500/40 border-cyan-300 scale-125"
...
style={{
    transform:`translate(${item.x}px,${item.y}px)`,
    opacity:selectedProduct===item.id ?1:0.3,
    filter:selectedProduct===item.id
        ?"blur(0px)"
        :"blur(3px)"
}}
Now when clicking
...
Click another device to explore.
...
/>
This gives the animated floating dots your professor described.
...
<div className="absolute w-[470px] h-[470px] rounded-full border border-white/10"/>
Final result
When users open the page:

✨ Background particles move slowly.

🔄 Lens and devices orbit around the center.

🎧 Clicking Earbuds enlarges and highlights them.

🌫️ All other products blur and fade.

💡 Information about the selected product appears below.

🖱️ Clicking another product switches the spotlight with a smooth animation.

This is much closer to the interactive experience your professor described than the current static hero section.


how to autoformat it ?

If you're using VS Code, there are several ways to auto-format your code.
...
Option 3 (Enable Auto Format on Save)
Open Settings
...
Now every time you press ⌘ + S (or Ctrl + S), VS Code formats your code automatically.

Option 4 (Install Prettier)
If formatting doesn't work, install Prettier.

Open the Extensions tab (⌘ + Shift + X or Ctrl + Shift + X).
...
Is this a React + Vite + TypeScript project?

What happens when you press Shift + Option + F? Do you get an error, or does nothing happen?

I can help you fix it in a minute.


Screenshot 2026-07-23 at 11.43.55 AM.png
Screenshot 2026-07-23 at 11.44.32 AM.png
is it correct 

Almost. There is one mistake.
...
rop-blur-lg
r
That means your template string is broken. It should look like this instead:
...
`}
Notice these class names are complete:
...
rop-blur-lg
r
Also make sure the order is like this:
<motion.button
    key={item.id}
...
If you're getting a red error, send me a screenshot that includes:

The red underline/error message.

About 15–20 lines above and below the <motion.button> code.

I can point out the exact line causing the problem.
...
<div className="pt-6 flex flex-col md items-center justify-between gap-3" style={{ borderTop: '1px solid rgba(255,255,255,0.08)' }}>
